...
The following result specifies how good of an estimate the Rayleigh
Quotient is.  According to Parlett this is the property to which ``the
phenomenal convergence rate [of RQI] can be
