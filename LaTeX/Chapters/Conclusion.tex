...
CRQI, our novel method. With various numerical examples we illustrated
that CRQI behaves much more predictable. In particular, we observed
that the method computes the correct result once the initial error
angle is below $45^\circ$.
...
discretise the original operator first and only then apply our method.
