...
fashion, cubic convergence of RQI is proofed by combining the
quadratic accuracy of the Rayleigh Quotient together with convergence
results from inverse iteration (since a single step of RQI is
equivalent to a single step of inverse iteration with the Rayleigh
quotient of the current iterate vector chosen as the shift), see for
...
\begin{example}
  ...
  example, when executed in Matlab \todo{Matlab} the method needs 36
  steps in total.
\end{example}
