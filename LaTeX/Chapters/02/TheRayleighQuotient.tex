...
estimate. RQI is essentially a combination of those two methods where
each step consists of one step of Shifted Inverse Iteration and the
computation of the Rayleigh Quotient. We summarise the results in
