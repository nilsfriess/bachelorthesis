...
\begin{example}
  ...
  \item Now take
    ...
    eigenvector that has the smallest angle with $\vec{x}^{(0)}$ but
...
can be used and ``tuned'' to improve the outer convergence. We will
briefly come back to the idea of solving the inner system inexactly
when discussing our new method in the next chapter.
