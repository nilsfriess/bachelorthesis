...
derived sharper bounds for local convergence neighborhoods. He
...
studied by Simoncini and Eld\'{e}n e in~\cite{simoncini2002rqi} and
...
step. Also~\cite{simoncini2002rqi} shows the equivalence of inexact
RQI and another iterative eigenvalue method called the
...
They also study how different preconditioners for the linear system
can be used and ``tuned'' to improve the outer convergence.
\todo{Conclude this overview?}
