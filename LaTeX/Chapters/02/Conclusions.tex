\section{Conclusions}%
In this chapter we saw that RQI possesses some very favourable
properties. It is practically impossible to make RQI fail to converge
to any eigenpair and convergence is locally cubic.  However, we also
discussed that in some cases it seems to be difficult, if not
...
even claim that this might be one of the reasons why RQI is not as
widely used as other iterative methods (another reason being its high
cost).

The main purpose of our novel method is to modify RQI in such a way
