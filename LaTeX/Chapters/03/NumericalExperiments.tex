...
\begin{figure*}[htpb]
  ...
  \caption[Effect of the initial error angle]{Plot of the computed
    ...
    target eigenvector for the Laplace matrix. While classic RQI even
    fails for very small angles, CRQI produces the correct result as
    soon as the angle is sufficiently small, which in these examples
    means approximately below $\pi/4$.}%
...
We conclude this chapter with a summary of the findings. 
