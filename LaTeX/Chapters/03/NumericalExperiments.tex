...
it seems that the idea that we motivated in the last section works.
...
eigenvalues. Although the method does generally require more
iterations than classic RQI, its convergence properties are still
appealing.

Regarding the speed of the method we have seen that the method does in
general require more iterations than classic RQI. However, it seems
that is mainly the preasymptotic phase that takes more steps. As soon
as the iterate is sufficiently good, convergence occurs in a similar
number of steps as in classic RQI. This is confirmed in the last
example. 
