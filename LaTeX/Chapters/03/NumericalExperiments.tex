...
observable in the figure below, further investiagion of other examples
...
and lowwer bound of the spectrum (indicated by the dotted area in the
...
below the center of the spectrum the behaviour is as in
Figure~\ref{fig:varying shift small negative} and for eigenvalues
above the center the method acts as in Figure~\ref{fig:varying shift
