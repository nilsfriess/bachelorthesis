...
$\norm*{\mat{A}\vec{x} - \mu \vec{x}}$ might be slightly larger than
the residual norm computed in the last iteration. In practice,
however, we observed that the final residual norm is still of the same
order as the norm of the residual computed in the last iteration.
