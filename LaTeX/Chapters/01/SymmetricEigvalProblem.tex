...
disciplines. In many cases the matrix of which the eigenvalues are
sought is real and symmetric. In this case, the task of finding
eigenvalues and eigenvectors is referred to as the \emph{symmetric
  eigenvalue problem}. For completeness, we collect some general facts
from linear algebra on eigenvalues and eigenvectors below.
...
\begin{remark}[Generalisations of eigenvalue problems]
  ...
  this thesis, we mostly consider problems of the
  form~\eqref{eq:eigvalproblem}. We will briefly come back to problems
