...
be zero it suffices that the vectors are a scalar multiple of each
other. For the error norm $\norm*{\vec{x}^{(k)} - \vec{z}}$ to be zero
they must also have the same norm. Since for eigenvectors only the
