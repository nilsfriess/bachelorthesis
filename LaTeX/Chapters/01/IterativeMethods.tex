...
approximations. According to Parlett~\cite[84--85]{Parlett1998}, it
...
when we discuss RQI. There, the system that is solved gets
increasingly ill-conditioned at each step but for the same reason as
above, in practice this poses no problem.
...
three assumptions. It is also adequate for problems with closely
spaced eigenvalues since it is precisely designed for such problems.

Apart from RQI and our new method we do not discuss any other
